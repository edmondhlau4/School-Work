...
class final_topo(Topo):
  def build(self):
    ...
    self.addLink(s1, CoreSwitch, port1=1, port2=1)
    self.addLink(s2, CoreSwitch, port1=1, port2=2)
    self.addLink(s3, CoreSwitch, port1=1, port2=3)
    
    self.addLink(CoreSwitch, trusted, port1=5, port2=0)
    self.addLink(CoreSwitch, untrusted, port1=6, port2=0)    
